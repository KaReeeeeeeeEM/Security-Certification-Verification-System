...
import { Shield, LogOut, User, Building } from "lucide-react"
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          <div className="flex items-center">
            ...
            <div>
              <h1 className="text-xl font-bold text-text-primary">Certificate Verification</h1>
              <p className="text-sm text-text-secondary">Protecting Academic Integrity</p>
            </div>
          </div>
