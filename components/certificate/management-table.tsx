...
export function ManagementTable({ certificates, onRefresh, onRevoke, onViewDetails, loading }: ManagementTableProps) {
  ...
  return (
    <>
            ...
            <div className="glass-dark rounded-lg p-4 border border-border">
              <div className="flex items-center gap-2">
                ...
                <div>
                  ...
                  <p className="text-text-primary font-semibold">{certificates.length}</p>
                </div>
              </div>
            </div>
            <div className="glass-dark rounded-lg p-4 border border-border">
            ...
            <div className="space-y-3">
              {filteredCertificates.map((certificate) => (
                <div
                  ...
                  className="glass-dark rounded-xl p-6 border border-border hover:border-primary-500/30 transition-all duration-200 animate-fade-in-up"
                >
                  <div className="flex items-start justify-between">
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-4 flex-1">
                      <div className="space-y-1">
                        ...
                        <p className="font-mono text-sm font-semibold text-text-primary">{certificate.certificateId}</p>
                      </div>
                      <div className="space-y-1">
                        <Label className="text-sm font-medium text-text-muted flex items-center gap-1">
                        ...
                        <p className="font-semibold text-text-primary">{certificate.studentName}</p>
                        <p className="text-sm text-text-muted">{certificate.course}</p>
                      </div>
                      <div className="space-y-1">
                        <Label className="text-sm font-medium text-text-muted flex items-center gap-1">
                        ...
                        <p className="text-sm text-text-primary">{certificate.institution}</p>
      ...
      <AlertDialog open={revokeDialog.open} onOpenChange={(open: boolean) => setRevokeDialog({ open, certificate: null })}>
        <AlertDialogContent className="bg-surface-elevated border-border">
          ...
          <AlertDialogFooter>
            <AlertDialogCancel className="border-border text-text-primary hover:bg-surface-hover">
              Cancel
            </AlertDialogCancel>
            <AlertDialogAction
